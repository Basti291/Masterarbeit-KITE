...
public class CollectStatsStep extends TestStep {
    ...
    protected void step() throws KiteTestException {
        ...
        int totalRampups = 2;
        int extraRounds = ((totalRampups - 1) - clientRampUpNumber) * 30; // 30 * 2 Sekunden = 60 Sekunden (die intervallzeit)      Für intervall hier ändern
        for (int i = 1; i <= 150 + extraRounds; i++) {              // am ENde alle zusasmmen 150 mal, also 5 Minuten lang
        //TODO die 20 wieder auf 150 ändern
            //TODO
        String script2 =
                "const getStatsValues = () =>" +
                        " window.webRTCAdaptor.remotePeerConnection.stream1.getStats()" +
                        "    .then(stats => {" +
                                "let filteredStats = [];" +
